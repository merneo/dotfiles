...
# EFFECTS ON SCRIPT
# Author: merneo
# Purpose: Enables desktop visual effects (blur, shadows, transparency).
# =============================================================================
...
send_notification "✓ Effects ENABLED" "Blur: On | Opacity: Transparent"
